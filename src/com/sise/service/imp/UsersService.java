...
public class UsersService implements IUsersService {
	 ...
	 * 根据用户名id获取用户对象
	 */
	public Users getUserByUserId(Users t){
		return (Users) usersDao.query("From Users where user_id like '"+t.getUserId()+"'").get(0);
	}
	...
	public void update(Users t){
		String sql = "update users set email='"+t.getEmail()+"' ,password='"+t.getPassword() +"' ,nick='"+t.getNick()+"' ,school='"
				+ t.getSchool() +"' where user_id='"+t.getUserId()+"'";
		usersDao.execute(sql);
	}
}
